...
export function setVolumedB(volumeDB: number): Promise<void>
export function setTrackPlayer(trackId: number, sec?: number | undefined | null): Promise<void>
...
export function getPlayerState(): any
